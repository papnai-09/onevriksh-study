...
async function seed() {
  ...
  console.log('Seed complete. Users synchronized with accounts.onevriksh.in account IDs.');
  console.log('Admin Account ID: 000000000000000000000001 (admin@onevriksh.com)');
  console.log('Student Account ID: 000000000000000000000002 (student@onevriksh.com)');
  process.exit(0);
}
