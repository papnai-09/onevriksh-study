      ...
      <section className="section values-section">
        <div className="container">
          ...
          <div className="value-grid">
            {[
              [Lightbulb, 'Practical first', 'Students learn through application, not memorisation.'],
              [HeartHandshake, 'Care deeply', 'Individual progress matters more than batch completion.'],
              [Award, 'Raise the bar', 'Our teaching, feedback and outcomes must earn trust.'],
              [Users, 'Grow together', 'A strong learning community makes everyone better.']
            ].map(([Icon, t, d]) => (
              <article key={t}>
                <Icon />
                <h3>{t}</h3>
        ...
        <div className="container trainer-grid">
          <div>
            <SectionHeading
              ...
              title="Industry experience, translated for the classroom."
              text="Our faculty combines subject expertise with the patience to teach. Every trainer is selected for practical experience, communication and commitment to student outcomes."
            />
            <div className="achievement-row">
              <div><strong>12+</strong><span>Expert trainers</span></div>
              <div><strong>8 yrs</strong><span>Average experience</span></div>
              <div><strong>25</strong><span>Students per batch</span></div>
            </div>
          </div>
