...
const fields = [
  ...
  { name: 'email', label: 'Email address', type: 'email', placeholder: 'you@example.com' },
  {
    ...
    type: 'select',
    options: ['Course enquiry', 'Free demo', 'Fee information', 'Career counselling', 'Other']
  },
  {
    name: 'message',
    label: 'Message',
    ...
    <>
      <section className="simple-hero">
        <div className="container">
          <span className="eyebrow light">Talk to us</span>
          <h1>Let&apos;s plan your next step.</h1>
          <p>Questions about courses, batches or careers? Our team is ready to help.</p>
        </div>
      </section>
      <section className="section contact-section">
        <div className="container contact-grid">
          <div>
            ...
            <h2>We&apos;re right in the heart of Delhi.</h2>
            <p>Drop in for counselling, attend a free demo, or reach us by phone and email.</p>
            <div className="contact-list">
              <a href="tel:+918700536553">
                <span>
                  <Phone size={18} />
                </span>
                <div>
          ...
          <FormCard
            ...
            subtitle="We usually respond within one working day."
            fields={fields}
