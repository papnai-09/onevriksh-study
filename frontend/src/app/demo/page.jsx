...
const fields = [
  ...
  },
  {
    ...
    type: 'select',
    options: ['Weekday morning', 'Weekday evening', 'Weekend']
  },
  {
    name: 'message',
      ...
      <div className="container demo-layout">
        <div className="demo-copy">
          ...
          <div className="demo-points">
            <span>
              <BadgeCheck size={18} /> Live trainer-led session
            </span>
            <span>
              <Users size={18} /> Small batch experience
            </span>
            <span>
              <Clock size={18} /> 45-minute class and counselling
            </span>
          </div>
        </div>
        <FormCard
          ...
          subtitle="Choose your course and our counsellor will confirm a slot."
          fields={fields}
          submitLabel="Reserve my demo seat"
        />
      </div>
    </main>
  );
